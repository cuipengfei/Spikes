...
public class PercentageDiscountTest {
    ...
    public void shouldCalculateDiscountByPercentage() throws Exception {
        ...
        Double price = percentageDiscount.price(OrderLineItem.create(Product.create("abc", "ItemXXX", "bottle", 123d), 10));
    ...
    public void shouldCalculateSavedByPrice() throws Exception {
        ...
        Double saved = percentageDiscount.savedByPrice(OrderLineItem.create(Product.create("abc", "ItemXXX", "bottle", 10d), 10));
