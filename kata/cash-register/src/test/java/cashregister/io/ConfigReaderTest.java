...
public class ConfigReaderTest {
    ...
    public void shouldLoadProducts() throws Exception {
        ...
        MatcherAssert.assertThat(products.get(0).appliedDiscounts().size(), is(2));

        MatcherAssert.assertThat(products.get(1).unit(), is("个"));
        MatcherAssert.assertThat(products.get(1).appliedDiscounts().size(), is(1));

        MatcherAssert.assertThat(products.get(2).singleUnitPrice(), is(5.5d));
        MatcherAssert.assertThat(products.get(2).appliedDiscounts().size(), is(3));
